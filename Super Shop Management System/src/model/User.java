...
public class User implements Serializable {
    ...
    // Add the getter method for VIP status
    public boolean isVip() {
        return isVip;
    }

    // Add setter method for VIP status
    ...
    public static User fromCSV(String csvLine) {
        try {
            ...
            if (parts.length != 9) {  // Changed from 8 to 9
            ...
            return new User(
                    ...
                    Boolean.parseBoolean(parts[4]),  // isAdmin
                    Boolean.parseBoolean(parts[5]),  // isVip
                    sdf.parse(parts[6]),  // registrationDate
                    parts[7].equals("null") ? null : sdf.parse(parts[7]),  // lastLoginDate
                    Boolean.parseBoolean(parts[8])  // isActive
            );
        } catch (Exception e) {
