...
public class Product implements Serializable {
    ...
    public Product(int id, int categoryId, String name, float price, int quantity, Date dateAdded) {
        ...
        this.dateAdded = new Date(dateAdded.getTime()); // Defensive copy
    ...
    // Getters - Added aliases for expected method names
    public int getId() {
        return id;
    }

    public int getProductId() {
        return id; // Alias for getId()
    }
    ...
    public String getCategory() {
        return String.valueOf(categoryId); // Or modify if you have category names
    }
    ...
    public Date getDateAdded() {
        return new Date(dateAdded.getTime()); // Defensive copy
    }
    ...
    // Setters with validation (unchanged)
